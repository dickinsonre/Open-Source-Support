...
#
# Purpose : Import a BEFDSS manhole surveys XML file into a Collection Network.
...
#   * Validates database, network, input XML existence
...
FILE_PATH  = 'C:\\temp\\BEFDSS_01_01_M.xml'
...
begin
  ...
  log "Importing manhole surveys from #{FILE_PATH}..."
  # nw.befdss_import_manhole_surveys(Filename, Flag, Images, MatchExisting, GenerateIDsFrom, DuplicateIDs, LogFile)
  nw.befdss_import_manhole_surveys(FILE_PATH, 'KT', false, false, 1, false, LOG_PATH)
  log 'Manhole survey BEFDSS import complete.'
rescue StandardError => e
  log "Aborted: #{e.message}"
ensure
  log 'fix_IE-befdss_import_manhole_surveys.rb finished.'
end
