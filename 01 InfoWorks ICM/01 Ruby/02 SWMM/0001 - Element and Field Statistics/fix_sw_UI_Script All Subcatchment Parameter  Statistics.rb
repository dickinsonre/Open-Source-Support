...
# All subcatchment parameter statistics (SWMM)
begin
  ...
  database_fields = ['area', 'imperv_percent', 'width', 'height', 'curb_length',
                     'snow_pack', 'user_number_1', 'user_number_2', 'user_number_3',
  ...
  net.row_objects('sw_subcatchment')&.each do |ro|
    row_count += 1
