...
# Purpose: Calculate tau (shear stress) statistics for conduits with unit selection
# Inputs: Selected conduits, prompt for unit system (USA/SI)
# Outputs: Console output with mean/max/min tau values per conduit
# Type: UI Script (WSApplication.prompt)
# Hardening: nil-safety, unit selection validation, empty results handling
