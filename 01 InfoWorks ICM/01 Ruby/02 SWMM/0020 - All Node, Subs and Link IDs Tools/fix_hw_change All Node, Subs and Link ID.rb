...
# -----------------------------------------------------------------------------
# Purpose : Rename every node, link and subcatchment in an InfoWorks (hw_*)
...
#   - Preserves original behaviour (in this fix link rename is enabled, was
#     commented out in the parent file - matches the file name's intent)
# =============================================================================
...
begin
  puts "[#{ts}] Starting hw_ Change All Node, Sub and Link IDs."
