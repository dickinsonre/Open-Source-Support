...
# fix_dave.rb
# ----------------------------------------------------------------------------
# Purpose : Hardened wrapper around dave.rb. Original is a simple
#           appreciation script that prints centered, bordered ASCII text
#           thanking Dave for his Ruby scripting work on ICM. No ICM
#           dependencies.
# Inputs  : None.
...
ORIGINAL_SCRIPT = File.join(__dir__, 'dave.rb').freeze
