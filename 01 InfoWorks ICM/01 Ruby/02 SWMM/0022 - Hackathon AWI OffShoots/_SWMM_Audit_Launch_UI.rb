# ============================================================================
# Launcher for SWMM Audit (UI script)
# ============================================================================
# Runs ICM_SWMM_Audit_Exchange.rb inside ICMExchange and streams its output.
#
...
PROBE = 'C:/temp/ICM_SWMM_Audit_Exchange.rb'
