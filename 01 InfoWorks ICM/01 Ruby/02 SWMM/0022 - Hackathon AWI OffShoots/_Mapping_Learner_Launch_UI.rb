# ============================================================================
# Launcher for Mapping Learner (UI script)
# ============================================================================
# Runs ICM_Mapping_Learner_Exchange.rb inside ICMExchange and streams its output.
#
...
PROBE = 'C:/temp/ICM_Mapping_Learner_Exchange.rb'
...
WSApplication.message_box(
  "Mapping Learner finished.\n\nReport:\nC:\\temp\\ICM_Mapping_Learner.html",
