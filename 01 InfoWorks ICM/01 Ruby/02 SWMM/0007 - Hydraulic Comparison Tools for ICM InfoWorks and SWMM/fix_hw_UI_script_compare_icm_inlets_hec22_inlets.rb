...
# Purpose: HEC-22 inlet efficiency comparison for InfoWorks ICM nodes (third variant)
# Inputs: Selected nodes with result data (DEPNOD, FloodDepth, GLLYFLOW, GTTRSPRD, INLETEFF, OVDEPNOD)
# Outputs: Console output with HEC-22 inlet efficiency calculations
# Type: UI Script
# Hardening: nil-safety, zero-guard on division, empty results validation
