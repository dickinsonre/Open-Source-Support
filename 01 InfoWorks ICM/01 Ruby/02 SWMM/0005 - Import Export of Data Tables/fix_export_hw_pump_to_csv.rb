...
#
# Purpose : Hardened wrapper around export_hw_pump_to_csv.rb.
# Inputs  : Active current_network with hw_pump rows + selection.
...
ORIGINAL = 'export_hw_pump_to_csv.rb'
...
begin
  ...
  log 'fix_export_hw_pump_to_csv.rb finished.'
end
