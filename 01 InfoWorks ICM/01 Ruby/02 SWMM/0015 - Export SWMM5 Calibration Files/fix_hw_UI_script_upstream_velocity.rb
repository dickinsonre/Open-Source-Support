...
# =============================================================================
# Purpose:
#   Hardened SWMM5 calibration export for upstream velocity (us_vel) on
...
begin
  ts_log "Starting Upstream Velocity SWMM5 calibration export"
  ...
  ts_log "Upstream Velocity export finished"
end
