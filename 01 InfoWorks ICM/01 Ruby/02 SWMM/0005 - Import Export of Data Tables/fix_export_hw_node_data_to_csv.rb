...
#
# Purpose : Hardened wrapper around export_hw_node_data_to_csv.rb.
# Inputs  : Active current_network with hw_node rows + selection.
...
ORIGINAL = 'export_hw_node_data_to_csv.rb'
...
begin
  ...
  log 'fix_export_hw_node_data_to_csv.rb finished.'
end
