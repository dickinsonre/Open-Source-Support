...
# =============================================================================
# Purpose:
#   Hardened SWMM5 calibration export for subcatchment groundwater elevation.
#   Reads the RUNOFF result series (groundwater elevation in this script's
#   context) for each selected hw_subcatchment and writes Day/Time/Value rows.
#
# Inputs:
...
#   - validates network and timesteps; per-row rescue
#   - skips rows whose results array doesn't match ts.size
# =============================================================================
...
begin
  ts_log "Starting Groundwater Elevation SWMM5 calibration export"
  ...
  puts ";Selected Subcatchments for Groundwater Elevation"
  puts ";         Day      Time  GroundwaterElevation"
  puts ";-----------------------------"
  ...
  ts_log "Groundwater Elevation export finished"
end
