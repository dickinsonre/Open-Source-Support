...
# Node user number statistics (SWMM)
begin
  ...
  database_fields = ["invert_elevation", "ground_level", "maximum_depth", "initial_depth",
                     "surcharge_depth", "ponded_area", "inflow_baseline", "inflow_scaling",
                     "base_flow", 'user_number_1', 'user_number_2', 'user_number_3',
