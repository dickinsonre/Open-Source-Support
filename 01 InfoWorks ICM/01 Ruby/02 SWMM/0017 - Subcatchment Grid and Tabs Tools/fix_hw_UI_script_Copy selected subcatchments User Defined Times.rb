...
# =============================================================================
# Purpose:
#   Hardened helper that copies each selected hw_subcatchment N times,
...
begin
  ts_log "Starting Copy selected subcatchments x N (hw_)"
