...
# ----------------------------------------------------------------------------
# Purpose : Hardened wrapper around current_background_conduit_compare.rb.
#           Original compares conduit parameters (length, Manning's n, US/DS
#           inverts, conduit height, headloss coefficients, "all common")
#           between current_network's hw_conduit and background_network's
#           sw_conduit, reporting per-parameter mean / max / min.
...
ORIGINAL_SCRIPT = File.join(__dir__, 'current_background_conduit_compare.rb').freeze
