...
# =============================================================================
# fix_hw_UI_script_upstream =low.rb (original filename has typo, preserved)
# =============================================================================
# Purpose:
#   Hardened SWMM5 calibration export for upstream flow (us_flow) on selected
#   conduits, with optional InfoWorks->SWMM5 ID asset_mapping.
#
# Inputs:
...
begin
  ts_log "Starting Upstream Flow SWMM5 calibration export"
  ...
  ts_log "Upstream Flow export finished"
end
