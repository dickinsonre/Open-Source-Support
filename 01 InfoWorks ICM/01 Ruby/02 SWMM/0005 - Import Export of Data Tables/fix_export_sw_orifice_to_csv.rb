...
#
# Purpose : Hardened wrapper around export_sw_orifice_to_csv.rb.
# Inputs  : Active current_network with sw_orifice rows + selection.
...
ORIGINAL = 'export_sw_orifice_to_csv.rb'
...
begin
  ...
  log 'fix_export_sw_orifice_to_csv.rb finished.'
end
