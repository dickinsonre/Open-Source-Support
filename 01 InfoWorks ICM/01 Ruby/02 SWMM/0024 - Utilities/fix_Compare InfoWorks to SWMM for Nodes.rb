...
# ----------------------------------------------------------------------------
# Purpose : Hardened wrapper around "Compare InfoWorks to SWMM for Nodes.rb".
#           Original compares attribute pairs between hw_node (current) and
#           sw_node (background) - ground_level, chamber_floor / invert
#           elevation, surcharge, depth, ponded area, surface area - and
#           reports differences plus totals.
...
ORIGINAL_SCRIPT = File.join(__dir__, 'Compare InfoWorks to SWMM for Nodes.rb').freeze
