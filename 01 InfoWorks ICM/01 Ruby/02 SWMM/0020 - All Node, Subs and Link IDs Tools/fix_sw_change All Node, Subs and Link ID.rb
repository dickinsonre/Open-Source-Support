...
# -----------------------------------------------------------------------------
# Purpose : Duplicate of the sister sw_change script - rename every node,
#           link and subcatchment in an ICM SWMM (sw_*) network to sequential
#           IDs (N_n, L_n, S_n).
...
begin
  puts "[#{ts}] Starting sw_ Change All Node, Sub and Link IDs."
