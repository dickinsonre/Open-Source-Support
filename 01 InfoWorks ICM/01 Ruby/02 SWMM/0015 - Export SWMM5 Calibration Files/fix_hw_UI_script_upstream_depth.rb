...
# =============================================================================
# Purpose:
#   Hardened SWMM5 calibration export for upstream depth (us_depth) on
#   selected conduits, with optional InfoWorks->SWMM5 ID asset_mapping.
#
# Inputs:
#   - Current network with results
#   - Selected conduit links (_links)
#   - asset_mapping at top of file (edit for your network)
#
# Outputs:
...
#   - per-row rescue; validates ts.size; nil-safe asset_id fallback
#   - preserves original behaviour (time_interval = (ts[1]-ts[0])*86400)
# =============================================================================
...
begin
  ts_log "Starting Upstream Depth SWMM5 calibration export"
  ...
  # Preserve original behaviour: time_interval = (ts[1]-ts[0])*86400
  ...
  ts_log "Upstream Depth export finished"
end
