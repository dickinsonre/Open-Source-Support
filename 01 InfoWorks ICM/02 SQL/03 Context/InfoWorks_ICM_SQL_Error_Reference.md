...
- Identify which pattern (PAT_SQL_XXX_NNN) provides the correct solution
...
**Solution:** See `InfoWorks_ICM_SQL_Schema_Common.md` and `InfoWorks_ICM_Database_Fields_Guide.md` Step 2 (MCP lookup). Ensure you use the correct **database field name**, not the UI display name. See PAT_SQL_SEL_004.
