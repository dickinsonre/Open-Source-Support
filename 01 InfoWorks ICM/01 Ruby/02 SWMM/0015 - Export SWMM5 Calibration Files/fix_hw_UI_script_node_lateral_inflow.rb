...
# =============================================================================
# Purpose:
#   Hardened SWMM5 calibration export for node lateral inflow (QNODE) on
#   selected nodes.
#
# Inputs:
...
#   - validates network/timesteps/results.size; per-row rescue
# =============================================================================
...
begin
  ts_log "Starting Node Lateral Inflow SWMM5 calibration export"
  ...
  ts_log "Node Lateral Inflow export finished"
end
