...
# =============================================================================
# Purpose:
#   Hardened helper that copies each selected sw_subcatchment once per
#   suffix in the `suffixes` list (defaults: Horton / GreenAmpt / Constant),
#   naming each copy "<original_id>_<suffix>".
#
...
begin
  ts_log "Starting Copy selected subcatchments by suffix (sw_)"
  ...
  ts_log "Copy by suffix (sw) finished"
end
