...
- If the user has not specified InfoWorks vs SWMM, **assume InfoWorks** (`hw_*`) and proceed unless the context is mixed or ambiguous.
...
- If signals conflict (mixed `hw_*`/`sw_*` hints), ask once to confirm before generating SQL.
