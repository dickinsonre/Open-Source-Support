...
# Purpose: HEC-22 inlet efficiency comparison for InfoWorks ICM nodes (duplicate)
# Inputs: Selected nodes with result data (DEPNOD, FloodDepth, GLLYFLOW, GTTRSPRD, INLETEFF, OVDEPNOD)
# Outputs: Console output with tabular HEC-22 vs ICM inlet calculations
# Type: UI Script
# Hardening: nil-safety, zero-guard on division, empty results handling
