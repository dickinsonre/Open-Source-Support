# ============================================================================
# Launcher for Make InfoWorks Shells (UI script)
# ============================================================================
# Runs ICM_Make_InfoWorks_Shells_Exchange.rb inside ICMExchange and streams its output.
#
...
PROBE = 'C:/temp/ICM_Make_InfoWorks_Shells_Exchange.rb'
...
WSApplication.message_box(
  "Make InfoWorks Shells finished.\n\nReport:\nC:\\temp\\(see Ruby output window)",
